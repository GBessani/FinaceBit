...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:top-0 lg:h-screen inset-y-0 left-0 z-50 w-64 bg-sidebar border-r border-sidebar-border transform transition-transform lg:transform-none ${
